...
public:
    ...
    // Como no se cuantas acciones me va a mandar el cliente, itero hasta que termine el receive
    void recibir_acciones_serializadas(bool& was_closed, uint8_t& mensaje_recibido);

    // Recibe las acciones del cliente, las deserializa y se las devuelve al server
